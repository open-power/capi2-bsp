...
if { [info exists ::env(OUTPUT_DIR)] == 1 } {
  ...
  set output_dir $::env(BUILD_DIR)/output
}
...
# Package IP
ipx::package_project -root_dir $output_dir/ip_repo -vendor ibm.com -library CAPI -taxonomy /UserIP -import_files -generated_files -force >> $log_file
...
#ipx::archive_core $output_dir/ibm.com_CAPI_PSL9_WRAP_$ver_major.$ver_minor.zip [ipx::current_core] >> $log_file
