...
foreach log $logs {
   if {[file exists $resultDir/${log}.log]} {
      file copy -force $resultDir/$log.log $resultDir/${log}_prev.log
   }
}

set RFH [open "$resultDir/$runLog.log" w]
set CFH [open "$resultDir/$commandLog.log" w]
set WFH [open "$resultDir/$criticalLog.log" w]
