...
### milan: Adding post-route phys_opt and re-route to achieve OOC timing closure
report_timing_summary -max_paths 100 -file $resultDir/${ooc_inst}_routetiming_summary.rpt
phys_opt_design -directive AggressiveExplore
report_route_status -file $resultDir/${ooc_inst}_postrouteopt_status.rpt
#route_design -preserve
write_checkpoint -force $resultDir/${ooc_inst}_postrouteopt_design.dcp
