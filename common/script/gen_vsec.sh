...
#This script helps you generate the vpd data (vpd44data_be) used in capi_vsec.vhdl
...
# TODO 1. Update Product information in vpd_CARDNAME.csv, use vpd_FlashGT.csv as an example TODO
# TODO 2. Modify the CompanyName and CardName on line 20 !!!                                TODO
