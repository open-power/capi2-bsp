...
component sem_ultra_0
  port (
    ...
    slr1_fecc_eccerrornotsingle : in std_logic;  --// input wire fecc_eccerrornotsingle
    slr2_fecc_eccerrornotsingle : in std_logic;  --// input wire fecc_eccerrornotsingle
    slr0_fecc_eccerrorsingle : in std_logic;       -- // input wire fecc_eccerrorsingle
    slr1_fecc_eccerrorsingle : in std_logic;       -- // input wire fecc_eccerrorsingle
    slr2_fecc_eccerrorsingle : in std_logic;       -- // input wire fecc_eccerrorsingle
    slr0_fecc_endofframe : in std_logic;             -- // input wire fecc_endofframe
    slr1_fecc_endofframe : in std_logic;             -- // input wire fecc_endofframe
    slr2_fecc_endofframe : in std_logic;             -- // input wire fecc_endofframe
    slr0_fecc_endofscan : in std_logic;                --  // input wire fecc_endofscan
    slr1_fecc_endofscan : in std_logic;                --  // input wire fecc_endofscan
    slr2_fecc_endofscan : in std_logic;                --  // input wire fecc_endofscan
    slr0_fecc_crcerror : in std_logic;                   -- // input wire fecc_crcerror
    slr1_fecc_crcerror : in std_logic;                   -- // input wire fecc_crcerror
    slr2_fecc_crcerror : in std_logic;                   -- // input wire fecc_crcerror
    slr0_fecc_far : in std_logic_vector(26 downto 0);      --// input wire [25 : 0] fecc_far
    slr1_fecc_far : in std_logic_vector(26 downto 0);      --// input wire [25 : 0] fecc_far
    slr2_fecc_far : in std_logic_vector(26 downto 0);      --// input wire [25 : 0] fecc_far
    slr0_fecc_farsel : out std_logic_vector(1 downto 0);     --// output wire [1 : 0] fecc_farsel
    slr1_fecc_farsel : out std_logic_vector(1 downto 0);     --// output wire [1 : 0] fecc_farsel
    slr2_fecc_farsel : out std_logic_vector(1 downto 0);     --// output wire [1 : 0] fecc_farsel
...
signal slr0_fecc_crcerror: std_logic;
signal slr1_fecc_crcerror: std_logic;
signal slr2_fecc_crcerror: std_logic;
signal slr0_fecc_eccerrornotsingle: std_logic;
signal slr1_fecc_eccerrornotsingle: std_logic;
signal slr2_fecc_eccerrornotsingle: std_logic;
signal slr0_fecc_eccerrorsingle: std_logic;
signal slr1_fecc_eccerrorsingle: std_logic;
signal slr2_fecc_eccerrorsingle: std_logic;
signal slr0_fecc_endofframe: std_logic;
signal slr1_fecc_endofframe: std_logic;
signal slr2_fecc_endofframe: std_logic;
signal slr0_fecc_endofscan: std_logic;
signal slr1_fecc_endofscan: std_logic;
signal slr2_fecc_endofscan: std_logic;
signal slr0_fecc_far: std_logic_vector(26 downto 0);
signal slr1_fecc_far: std_logic_vector(26 downto 0);
signal slr2_fecc_far: std_logic_vector(26 downto 0);
signal slr0_fecc_farsel: std_logic_vector(1 downto 0);
signal slr1_fecc_farsel: std_logic_vector(1 downto 0);
signal slr2_fecc_farsel: std_logic_vector(1 downto 0);
...
Signal slr0_status_heartbeat : std_logic;
Signal slr1_status_heartbeat : std_logic;
Signal slr2_status_heartbeat : std_logic;
...
crcerror <= slr0_fecc_crcerror or slr1_fecc_crcerror or slr2_fecc_crcerror;
eccerrornotsingle <= slr0_fecc_eccerrornotsingle or slr1_fecc_eccerrornotsingle or slr2_fecc_eccerrornotsingle;
eccerrorsingle <= slr0_fecc_eccerrorsingle or slr1_fecc_eccerrorsingle or slr2_fecc_eccerrorsingle;
...
port map (
slr0_status_heartbeat => slr0_status_heartbeat,
slr1_status_heartbeat => slr1_status_heartbeat,
slr2_status_heartbeat => slr2_status_heartbeat,
...
slr0_fecc_eccerrornotsingle => slr0_fecc_eccerrornotsingle,  --// input wire fecc_eccerrornotsingle
slr1_fecc_eccerrornotsingle => slr1_fecc_eccerrornotsingle,  --// input wire fecc_eccerrornotsingle
slr2_fecc_eccerrornotsingle => slr2_fecc_eccerrornotsingle,  --// input wire fecc_eccerrornotsingle
slr0_fecc_eccerrorsingle => slr0_fecc_eccerrorsingle,       -- // input wire fecc_eccerrorsingle
slr1_fecc_eccerrorsingle => slr1_fecc_eccerrorsingle,       -- // input wire fecc_eccerrorsingle
slr2_fecc_eccerrorsingle => slr2_fecc_eccerrorsingle,       -- // input wire fecc_eccerrorsingle
slr0_fecc_endofframe => slr0_fecc_endofframe,             -- // input wire fecc_endofframe
slr1_fecc_endofframe => slr1_fecc_endofframe,             -- // input wire fecc_endofframe
slr2_fecc_endofframe => slr2_fecc_endofframe,             -- // input wire fecc_endofframe
slr0_fecc_endofscan => slr0_fecc_endofscan,                --  // input wire fecc_endofscan
slr1_fecc_endofscan => slr1_fecc_endofscan,                --  // input wire fecc_endofscan
slr2_fecc_endofscan => slr2_fecc_endofscan,                --  // input wire fecc_endofscan
slr0_fecc_crcerror => slr0_fecc_crcerror,                   -- // input wire fecc_crcerror
slr1_fecc_crcerror => slr1_fecc_crcerror,                   -- // input wire fecc_crcerror
slr2_fecc_crcerror => slr2_fecc_crcerror,                   -- // input wire fecc_crcerror
slr0_fecc_far => slr0_fecc_far,      --                        // input wire [25 : 0] fecc_far
slr1_fecc_far => slr1_fecc_far,      --                        // input wire [25 : 0] fecc_far
slr2_fecc_far => slr2_fecc_far,      --                        // input wire [25 : 0] fecc_far
slr0_fecc_farsel => slr0_fecc_farsel,     --                   // output wire [1 : 0] fecc_farsel
slr1_fecc_farsel => slr1_fecc_farsel,     --                   // output wire [1 : 0] fecc_farsel
slr2_fecc_farsel => slr2_fecc_farsel,     --                   // output wire [1 : 0] fecc_farsel
