...
While the first version of CAPI was designed for acceleration in a POWER8 system, its successor CAPI 2.0 is the CAPI version for POWER9 systems.

For more information on CAPI, see https://developer.ibm.com/linuxonpower/capi/
...
The build process for the CAPI 2.0 board support depends on POWER9 PSL (PSL9) sources that can be obtained as zip archive from the IBM Portal for OpenPOWER at
...
Please copy that file to the subdirectory [psl](./psl).
