...
# SUBSYSTEM_ID: 0x0669
# PCIE_ID_IF = false
# PCIE BANK 227/226/225/224 (SLR1 X1Y1)
# U50 uses X1Y1 location, GTY quad 227, and pcie4c 

# user can set a specific value for the Action clock lower than the 250MHz nominal clock
set action_clock_freq 225MHz
#overide default value if variable exist - disabled by hnaser
